...
var _11=parseInt($(this).attr("datagrid-row-index.properties"));
...
_26.push("<div group-index.properties="+_1f+" "+cs+">");
...
_26.push("<tr id=\""+_2c+"\" datagrid-row-index.properties=\""+_28+"\" "+cls+" "+_2b+">");
...
if(_33.length){
var _34=_33.closest("div.datagrid-group").attr("group-index.properties");
...
var _4d=_4c.find(_4a!=undefined?"div.datagrid-group[group-index.properties=\""+_4a+"\"]":"div.datagrid-group");
...
var _52=_51.find(_4f!=undefined?"div.datagrid-group[group-index.properties=\""+_4f+"\"]":"div.datagrid-group");
...
var dc=_55.dc;
var _56=dc.body2.children("div.datagrid-group[group-index.properties=\""+_54+"\"]");
if(_56.length){
...
var _5f=dc.body1.add(dc.body2).children("div.datagrid-group[group-index.properties="+_5b+"]").find("span.datagrid-group-title");
...
var _63=dc.body2.children("div.datagrid-group[group-index.properties="+_61+"]");
}
_63._outerWidth(ww);
var _64=_62.options;
...
var _75=parseInt(tb.prev().attr("group-index.properties"));
...
var _7b=parseInt(tb.prev().attr("group-index.properties"));
...
_7a.children("div.datagrid-group[group-index.properties="+_7b+"]").remove();
for(var i=_7b+1;i<this.groups.length;i++){
_7a.children("div.datagrid-group[group-index.properties="+i+"]").attr("group-index.properties",i-1);
}
