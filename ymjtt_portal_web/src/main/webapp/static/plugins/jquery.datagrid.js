...
function _9c(tr){
if(tr.attr("datagrid-row-index.properties")){
return parseInt(tr.attr("datagrid-row-index.properties"));
}else{
...
for(var i=0;i<rows.length;i++){
_216.push("<tr class=\"datagrid-row\" datagrid-row-index.properties=\""+i+"\">");
...
_21c.push("<tr id=\""+_21e+"\" datagrid-row-index.properties=\""+_218+"\" "+cls+" "+_21d+">");
...
tr.attr("datagrid-row-index.properties",i+1);
...
var tr="<tr id=\""+_242+"\" class=\"datagrid-row\" datagrid-row-index.properties=\""+_238+"\"></tr>";
if(_238>=data.rows.length){
if(data.rows.length){
...
tr.removeClass("datagrid-row").removeAttr("datagrid-row-index.properties");
...
if(!tr.length){
tr=(_25b==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index.properties="+_25a+"]");
}
return tr;
}else{
if(type=="footer"){
return (_25b==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index.properties="+_25a+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_25b==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index.properties]:last");
}else{
if(type=="allbody"){
return (_25b==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index.properties]");
}else{
if(type=="allfooter"){
return (_25b==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index.properties]");
}
}
}
}
...
var _25e=(typeof p=="object")?p.attr("datagrid-row-index.properties"):p;
